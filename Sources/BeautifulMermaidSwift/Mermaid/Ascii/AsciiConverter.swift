...
public enum AsciiConverter {

    // MARK: - Shared ASCII model types (used by grid/pathfinder/index shims)

    // Single canonical coordinate types live in AsciiTypes; these were
    // byte-identical transpiler twins.
    ...
    public final class AsciiNode: @unchecked Sendable {
        ...
        public init(
            ...
            drawn = false
            styleClassName = ""
            styleClass = AsciiConverter.EMPTY_STYLE
        }
    }
    ...
    public final class AsciiGraph: @unchecked Sendable {
        ...
        public var grid: [GridCoord: AsciiNode]
