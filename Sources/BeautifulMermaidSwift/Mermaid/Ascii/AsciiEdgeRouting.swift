...
public func gridCoordEquals(_ a: GridCoord, _ b: GridCoord) -> Bool {
    AsciiTypes.gridCoordEquals(a, b)
}

public func gridCoordDirection(_ c: GridCoord, _ dir: Direction) -> GridCoord {
    AsciiTypes.gridCoordDirection(c, dir)
}

public func getPath(_ grid: [GridCoord: AsciiNode], _ from: GridCoord, _ to: GridCoord) -> [GridCoord]? {
    struct PQItem {
        var coord: GridCoord
        var priority: Int
    }
